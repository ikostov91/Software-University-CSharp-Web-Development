    ...
    public class HttpServer : IHttpServer
    {
        ...
        public void Start()
        {
            ...
            while (this.isWorking)
            {
                ...
                var responseBytes = Encoding.UTF8.GetBytes("HTTP/1.0 301 Moved Permanently" + Environment.NewLine +
                    "Location: https://www.facebook.com" + Environment.NewLine + Environment.NewLine
                    // "Content-Type: text/plain" +
                    //"Content-Disposition: attachment; filename=index.exe" +
